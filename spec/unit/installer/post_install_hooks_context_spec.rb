...
module Pod
  describe Installer::PostInstallHooksContext do
    it 'offers a convenience method to be generated' do
      ...
      pod_target = PodTarget.new(sandbox, false, {}, [], Platform.ios, [target_definition],
                                 [fixture_file_accessor(spec)], nil)
      umbrella = AggregateTarget.new(sandbox, false, {}, [], Platform.ios, target_definition,
