module Pod
  # Stores the information relative to the target used to compile a single Pod.
    ...
    # @return [Array<TestPodTarget>] the test pod targets that are part of this pod target.
    #
    attr_accessor :test_pod_targets
    ...
    def initialize(specs, target_definitions, sandbox, scope_suffix = nil)
      ...
      super()
      @specs = specs.reject(&:test_specification?).dup.freeze
