module Pod
  ...
  class PodTarget < Target
    ...
    #
    # @param  [Boolean] include_test_framework_paths
    ...
    def framework_paths(include_test_framework_paths = true)
      ...
      accessors = accessors.reject { |a| a.spec.test_specification? } unless include_test_framework_paths
      frameworks = []
    ...
    # that are part of test specifications.
    #
    # @param  [Boolean] include_test_resources
    ...
    #
    def resource_paths(include_test_resources = true)
      accessors = file_accessors
      accessors = accessors.reject { |a| a.spec.test_specification? } unless include_test_resources
