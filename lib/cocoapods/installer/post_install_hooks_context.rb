    ...
    class PostInstallHooksContext
      ...
      def self.generate(sandbox, aggregate_targets)
        ...
        aggregate_targets.each do |umbrella|
          ...
          umbrella_targets_descriptions << UmbrellaTargetDescription.new(user_project, user_targets, specs, platform_name, platform_deployment_target, cocoapods_target_label)
        end
