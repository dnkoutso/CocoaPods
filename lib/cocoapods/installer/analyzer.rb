...
module Pod
  class Installer
    ...
    class Analyzer
      ...
      #         thhe BuildType to use for this pod target.
      #
      # @param  [Hash{TargetDefinition => TargetInspectionResult}] target_inspections
      #         the user target inspections used to construct the aggregate and pod targets.
      #
      ...
      # @return [Platform]
      #
      def determine_platform(specs, target_definitions, host_build_type)
        ...
        if platform_name == :ios && host_build_type.framework?
